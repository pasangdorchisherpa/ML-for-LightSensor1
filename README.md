...
Instead of feeding the NN a single reading, I feed it a window of 32 readings at once. One reading is too noisy to be useful — but a pattern of 32 readings contains enough information to make a confident prediction. This is the same reason your real SRC system uses 128-sample windows.
